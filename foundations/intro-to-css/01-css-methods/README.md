...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? ye
- Did you properly link the external CSS file in the HTML file? ye
- Does the `div` element have CSS added via the external method? ye
- Does the `p` element have CSS added via the internal method? ye
- Does the `button` element have CSS added via the inline method? ye
